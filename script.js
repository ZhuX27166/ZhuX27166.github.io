document.addEventListener("DOMContentLoaded", () => {
  ...
  function detectLanguage() {
    const saved = localStorage.getItem("fourallies_lang");
  ...
  function setLanguage(lang) {
    ...
    // Save to storage
    localStorage.setItem("fourallies_lang", lang);
    ...
    i18nElements.forEach(el => {
      ...
      if (translations[lang][key]) {
        // If string contains HTML (e.g. bold or line breaks), use innerHTML, otherwise textContent
